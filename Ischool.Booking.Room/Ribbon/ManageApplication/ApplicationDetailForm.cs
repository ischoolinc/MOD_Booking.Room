...
namespace Ischool.Booking.Room
{
    public partial class ApplicationDetailForm : BaseForm
    {
        ...
        {
            DataTable dt = DAO.Application.GetApplicationByID(this._applicationID);
            ...
            applyDateLb.Text = string.Format("申請時間: {0}",DateTime.Parse(appR.ApplyDate).ToString("yyyy/MM/dd"));
            ...
            foreach (string appDetailUID in appDetailDic.Keys)
            {
                ...
                {
                    datarow.Cells[index++].Value = DateTime.Parse("" + appDetailDic[appDetailUID].StartTime).ToString("yyyy/MM/dd");
