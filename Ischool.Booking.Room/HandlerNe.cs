...
{
    class HandlerNe : IRequestHandler
    {
        ...
        {
            //if (request.Url.Contains("http://feature.ischool.com.tw/"))
            //{
            //    string new_url = request.Url.Replace("http://feature.ischool.com.tw/", "");
            //    new_url = HttpUtility.UrlDecode(new_url);
            //    Features.Invoke(new_url);
            //    return true;
            //}
